...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val name= arrayOf("Stephen", "Steven","Gaven", "Nevin","Selah", "Levin","Logan", "Ziya")
        val lastmassege=arrayOf("Let’s catch up soon","Good Morning","Good Night","How are you","Keep shining, my friend","Good Morning","Good Night","Wishing you good vibes")
